...
console.table(_ships.default.getShipByName("Executor")); // check to see if javascript is working

function component() {
  var element = document.createElement("p");
  element.innerHTML = "Setup Appears to be working &#128521;"; //element.innerHTML = shipController.getShipByName("Executor");
